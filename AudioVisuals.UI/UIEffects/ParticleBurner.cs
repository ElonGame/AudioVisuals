...
namespace AudioVisuals.UI
{
    public class ParticleBurner
    {
        ...
        // Noise
        private const float CurlEpsilon = 1.0f;
        ...
        public void Init(OpenGL gl)
        {
            ...
            _emitterLocation.Init(0.0f, 13.0f, 0.0f, 20.0f, 30.0f, 0.0f, 0.2f, 0.2f, 0.0f);
